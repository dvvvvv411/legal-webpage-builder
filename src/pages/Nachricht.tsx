        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_auto] 2xl:grid-cols-[auto_1fr_auto] justify-center xl:!justify-between w-full min-h-full">
          ...
          <div className="xl:w-[440px] hidden xl:block">
            <div className="bg-card-input-bg px-12 py-10 h-full">
              ...
              <div className="mt-12">
                <p className="mb-2 flex items-center gap-2 text-sm font-semibold" style={{ color: 'hsl(var(--dark-slate))', fontSize: '1.1em' }}>
              ...
              <div className="mt-6 flex gap-2">
                <p className="mb-2 flex items-center gap-2 text-sm font-semibold mb-0" style={{ color: 'hsl(var(--dark-slate))', fontSize: '1.1em' }}>
