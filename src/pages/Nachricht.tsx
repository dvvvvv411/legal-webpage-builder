        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_auto] 2xl:grid-cols-[auto_1fr_auto] justify-center xl:!justify-between w-full min-h-full">
          ...
          <div className="xl:w-[440px] hidden xl:block">
            <div className="bg-card-input-bg px-12 py-10 h-full">
              ...
              <div className="mt-12">
                <p className="mb-2 flex items-center gap-2 font-semibold text-dark-slate" style={{ fontSize: '1.1em' }}>
                  <Scale className="shrink-0 text-dark-slate" size={18} />
                  Rechtsgebiete:
                </p>
              ...
              <div className="mt-6 flex gap-2">
                <p className="mb-2 flex items-center gap-2 font-semibold mb-0 text-dark-slate" style={{ fontSize: '1.1em' }}>
                  <svg className="shrink-0 text-dark-slate" width="18" height="18" viewBox="0 0 576 512" fill="currentColor">
